...
const DanhSachBanthao = () => {
    ...
    const fetchDrafts = async () => {
        try {
            const res = await axios.get('https://hkl-backend.onrender.com/api/admin/ban-thao/all');
            if (res.data.success) {
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmDelete) {
            try {
                const res = await axios.delete(`https://hkl-backend.onrender.com/api/admin/ban-thao/delete/${id}`);
                if (res.data.success) {
