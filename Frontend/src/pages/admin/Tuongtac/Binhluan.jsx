...
const Binhluan = () => {
    ...
    const fetchData = async () => {
        try {
            setLoading(true);
            const res = await axios.get('https://hkl-backend.onrender.com/api/admin/binh-luan/all');
    ...
    const handleDelete = async (id) => {
        if (window.confirm("Bạn có chắc muốn xóa bình luận này?")) {
            try {
                const res = await axios.delete(`https://hkl-backend.onrender.com/api/admin/binh-luan/delete/${id}`);
                if (res.data.success) {
