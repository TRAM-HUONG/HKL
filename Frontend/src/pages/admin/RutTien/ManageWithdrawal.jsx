...
const ManageWithdrawal = () => {
    ...
    const fetchRequests = async () => {
        setLoading(true);
        try {
            const response = await axios.get('https://hkl-backend.onrender.com/api/user/withdraw/requests');
    ...
    const handleApprove = async (yc) => {
        ...
        if (window.confirm(confirmMsg)) {
            try {
                const res = await axios.put(`https://hkl-backend.onrender.com/api/user/withdraw/approve`, {
                    mayc: yc.mayc,
                    matk: yc.matk,
                    so_xu: yc.so_xu_rut
                });
    ...
    const handleReject = async (mayc) => {
        ...
        try {
            const res = await axios.put(`https://hkl-backend.onrender.com/api/user/withdraw/reject`, { mayc, reason });
            if (res.data.success) {
