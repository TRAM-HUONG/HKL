...
const SuaBanThao = () => {
    ...
    useEffect(() => {
        const fetchDetail = async () => {
            try {
                const res = await axios.get(`http://localhost:5173//api/author/ban-thao/${id}`);
                if (res.data.success) {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const res = await axios.put(`http://localhost:5173//api/author/update-ban-thao/${id}`, formData);
            if (res.data.success) {
