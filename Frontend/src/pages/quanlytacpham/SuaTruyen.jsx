...
const SuaTruyen = () => {
        ...
        const fetchData = async () => {
            try {
                const [tlRes, trRes] = await Promise.all([
                    axios.get('http://localhost:5173//api/author/the-loai'),
                    axios.get(`http://localhost:5173//api/author/truyen/${id}`)
                ]);
                ...
                if (trRes.data.success) {
                    ...
                    setPreviewImage(`http://localhost:5173//images/${d.hinhanh || d.HINHANH}`);
                }
            } catch (err) { 
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.put(`http://localhost:5173//api/author/update-truyen/${id}`, data, {
